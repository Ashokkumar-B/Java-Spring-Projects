 ...
 */
public class WindowLockUnlockListen extends JFrame implements WindowProc {
	...
	File file = new File("U:/Log.csv");
    BufferedWriter out = null;
    String line1;
    String line2;
    String line3;
    
    public void log(String ses){
    	try {
			...
			String string1 = dateFormat1.format(cal.getTime());
			String string2 = dateFormat2.format(cal.getTime());

			BufferedReader reader1 = new BufferedReader(new InputStreamReader(
					new ByteArrayInputStream(string1.getBytes())));
			BufferedReader reader2 = new BufferedReader(new InputStreamReader(
					new ByteArrayInputStream(string2.getBytes())));
	...
	public WindowLockUnlockListen() {
		...
		wClass.lpfnWndProc = WindowLockUnlockListen.this;
		...
		HWND hWnd = User32.INSTANCE
				.CreateWindowEx(
						...
						0, 0, 0, 0, 0, null, // WM_DEVICECHANGE contradicts
	...
	protected void onMachineLocked(int sessionId) {
		System.out.println("MachineLocked: ");
		log("OUT");
	}
	...
	protected void onMachineUnlocked(int sessionId) {
		System.out.println("MachineUnlocked: ");
		log("IN");
	}
	...
	protected LRESULT onDeviceChangeArrivalOrRemoveComplete(LPARAM lParam,
			String action) {
		...
		case DBT.DBT_DEVTYP_DEVICEINTERFACE: {
			// see
			// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363244.aspx
		...
		case DBT.DBT_DEVTYP_HANDLE: {
			// see
			// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363245.aspx
			DEV_BROADCAST_HANDLE bhd = new DEV_BROADCAST_HANDLE(
					bhdr.getPointer());
		...
		case DBT.DBT_DEVTYP_OEM: {
			// see
			// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363247.aspx
		...
		case DBT.DBT_DEVTYP_PORT: {
			// see
			// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363248.aspx
		...
		case DBT.DBT_DEVTYP_VOLUME: {
			// see
			// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363249.aspx
			DEV_BROADCAST_VOLUME bvl = new DEV_BROADCAST_VOLUME(
					bhdr.getPointer());
		...
		// see
		// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363205.aspx
		// see
		// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363208.aspx
	...
	protected LRESULT onDeviceChangeNodesChanged() {
		...
		// return TRUE means processed message for this wParam.
		// see
		// http://msdn.microsoft.com/en-us/library/windows/desktop/aa363211.aspx
		return new LRESULT(1);
	}
